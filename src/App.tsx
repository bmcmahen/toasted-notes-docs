          ...
          >
            <DarkMode>
              ...
              <Text css={{ maxWidth: "38rem" }} variant="lead">
                Toasted notes provides completely configurable toast
                notifications for your React application and it uses an
                imperative API which makes it easy to invoke within error or
                event handlers.
              </Text>
              <Button
                intent="primary"
      ...
      <div css={{ padding: "1rem" }}>
        ...
        `}
          ...
          <div css={{ textAlign: "center", margin: theme.spaces.lg }}>
            ...
            <br />
            <br />
            <Text muted css={{ fontSize: theme.fontSizes[0] }}>
...
function Section({ subtitle, code, title, example }: SectionProps) {
  ...
  return (
    ...
    >
      <section css={{}}>
        <div css={{ padding: theme.spaces.lg, paddingBottom: 0 }}>
        ...
        <div css={{ padding: theme.spaces.lg, paddingTop: 0 }}>
          <Button
...
function Divider({ fill, ...other }: any) {
  const theme = useTheme();
  let filler = fill || theme.colors.palette.gray.dark;
  return (
    <div
      css={{
        display: "none",
